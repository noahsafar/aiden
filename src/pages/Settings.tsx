...
import { Bell, Moon, Users, Zap, Check, LogOut, Sun, Moon as MoonIcon, ArrowLeft, Type, Palette, Eye } from 'lucide-react';
...
export function Settings() {
  ...
  const { setTheme: setThemeMode, setFontSize, isDark } = useThemeStore();
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900">
      ...
      <header className="h-14 bg-white dark:bg-gray-800 border-b border-gray-200 dark:border-gray-700 flex items-center justify-between px-4 z-10">
        ...
        <div className="flex items-center space-x-2">
          ...
          <button
            onClick={() => setThemeMode(settings.theme)}
        ...
        <div className="space-y-6">
          ...
          <section className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
            ...
            <div className="p-6 space-y-6">
              ...
              {/* Font Size */}
              <div className="border-t border-gray-200 dark:border-gray-700 pt-6">
                <p className="font-medium text-gray-900 dark:text-white mb-1">Font Size</p>
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Adjust text size throughout the app</p>
                <div className="grid grid-cols-3 gap-3">
